...
# preprocessed_11k: 10274 image-text pairs (1.7GB in tar.gz; 1.8GB data folder)
# preprocessed_212k: 212776 image-text pairs (18GB tar.gz; 20GB data folder)

DATA_TYPE=$1  # {preprocessed_11k, preprocessed_212k}
