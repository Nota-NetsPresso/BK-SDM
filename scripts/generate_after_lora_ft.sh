...
MODEL_DIR="./results_ft/lora/$SUBJECT_NAME/bk-sdm-base" # the path of LoRA weights; please adjust it if needed
...
CUDA_VISIBLE_DEVICES=2 python3 src/generate_single_prompt.py \
    --use_dpm_solver \
    --model_id $SRC_MODEL \
    --save_dir $IMG_DIR \
