...
def parse_args():
    ...
    parser.add_argument("--unet_path", type=str, default="./results/toy_bk_small/checkpoint-15")   
    parser.add_argument("--save_dir", type=str, default="./results/toy_bk_small/checkpoint-15_gen")
...
if __name__ == "__main__":
    ...
    # use a separate trained unet for generation       
    unet = UNet2DConditionModel.from_pretrained(args.unet_path, subfolder='unet')
    pipeline.pipe.unet = unet.half().to(f"{args.device}")
